...
Counting note: unit 00 carries two figures, so 37 figures cover 36 units. Unit 40, the
capstone, needs none, which leaves 46 units wanting a figure and 10 still without.

---

## Done: 37 figures, covering 36 of the 46 units that need one
...
and the console; `30-01` an expression object and its result; `26-01` the shader editor beside its
...
`p4-01` the installation's structure, generated the same way; `p3-01` the mapping bench,
assembled by Edu and captured from the committed document.
